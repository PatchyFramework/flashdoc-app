...
<body class="max-h-screen">
  ...
  {{-- Overview --}}
    <div class="p-2">
      ...
      <div class="w-full h-[30%] flex flex-row rounded-lg py-2 px-2 space-x-10">
        <div class="w-[30%] bg-white pt-8 pb-2 rounded-lg shadow-lg border-gray-300 border-opacity-50 border">
          ...
          <a href="{{ route('admin.janji.index') }}" class="flex justify-end text-solidorange text-xs mr-5 mt-3">Lihat Data ></a>
        ...
        <div class="w-[30%] bg-white pt-8 pb-2 rounded-lg shadow-lg border-gray-300 border-opacity-50 border">
          ...
          <a href="{{ route('admin.flashpharmacy.index') }}" class="flex justify-end text-solidorange text-xs mr-5 mt-3">Lihat Data ></a>
        ...
        <div class="w-[30%] bg-white pt-8 pb-2 rounded-lg shadow-lg border-gray-300 border-opacity-50 border">
          <div class="flex justify-center items-center  space-x-5">
            <div class="font-bold text-4xl text-solidorange mr-3">{{ $faskescount }}</div>

            <div class="flex flex-col text-black">
              <p class="font-bold text-base">Fasilitas Kesehatan</p>
              <p class="font-normal text-sm">Telah Diinput</p>
            </div>
          </div>

          <a href="{{ route('admin.faskes.index') }}" class="flex justify-end text-solidorange text-xs mr-5 mt-3">Lihat Data ></a>
        ...
        data: {
            ...
            datasets: [
                ...
                },
                {
                    ...
                    data: [{{$faskescount}}],
                    backgroundColor: 'rgba(75, 192, 192, 0.2)', // Warna latar belakang untuk data fasilitas kesehatan
                    borderColor: 'rgba(75, 192, 192, 1)', // Warna border untuk data fasilitas kesehatan
                    borderWidth: 1
                }
            ]
        },
