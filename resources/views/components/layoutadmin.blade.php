...
<body class="font-quicksand">
        <div class="flex mx-auto">
            <div class="flex-row my-auto basis-[20%] bg-darkblue h-screen pt-10">
                ...
                <h1 class="flex font-bold text-solidorange text-xl justify-center items-center">Administrator</h1>



                <div class="h-[600px] flex items-center justify-center">
                    <div class="h-[280px] w-[250px] flex flex-col items-center justify-center rounded-xl text-white bg-[#042A3E] p-3 space-y-5">
                        ...
                        <div class="flex flex-row border-b-2 border-white p-2 w-[90%] space-x-2 hover:text-solidorange">
                            <i class="fa-solid fa-hospital flex justify-center items-center"></i>
                            <a href="faskes" class="hover:text-solidorange focus:text-solidorange">Fasilitas Kesehatan</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="flex-col h-[70px] shadow-lg basis-[80%] px-5">
                <div class="flex justify-between items-center h-full">
                    ...
                    <div class="flex items-center justify-center space-x-3 text-md font-normal">
                        <img src="{{ asset(Auth::user()->profile_picture) }}" alt="Admin Photo" class="h-[50px] max-h-[50px] object-fill rounded"/>
